          ...
          treefmt = {
            ...
            settings = {
              global.excludes = [
                ...
                # what the tool wrote.
                "benchmarks/results/**"
                # Generated by scripts/build_pypi_index.py: deterministic PEP
                # 503 index pages, not hand-edited. Reformatting would only
                # drift again on the next release-workflow run.
                "docs/simple/**"
              ];
              formatter = {
                shellcheck.options = [
